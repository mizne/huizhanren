...
export const getVisitorAreaFilters = createSelector(selectVisitorState, fromVisitor.getAreaFilters)
export const getVisitorTypeFilters = createSelector(selectVisitorState, fromVisitor.getTypeFilters)

...
export const selectExhibitorModuleState = createFeatureSelector<ExhibitorState>(
  'exhibitorModule'
)
...
export const getExhibitors = createSelector(
  ...
  fromExhibitor.getExhibitors
)
export const getExhibitorsTotalCount = createSelector(
  selectExhibitorState,
  fromExhibitor.getExhibitorsTotalCount
)
export const getCurrentExhibitorCount = createSelector(
  selectExhibitorState,
  fromExhibitor.getCurrentExhibitorCount
)
export const getExhibitorAreaFilters = createSelector(
  selectExhibitorState,
  fromExhibitor.getAreaFilters
)
export const getExhibitorTypeFilters = createSelector(
  selectExhibitorState,
  fromExhibitor.getTypeFilters
)
export const getListStatus = createSelector(
  selectExhibitorState,
  fromExhibitor.getListStatus
)
export const getPageStatus = createSelector(
  selectExhibitorState,
  fromExhibitor.getPageStatus
)
export const getExhibitorShowDetailID = createSelector(
  selectExhibitorState,
  fromExhibitor.getShowDetailID
)
export const getExhibitorShouldScrollToTop = createSelector(
  selectExhibitorState,
  fromExhibitor.getShouldScrollToTop
)
export const getCurrentLogs = createSelector(
  selectExhibitorState,
  fromExhibitor.getLogs
)
...
export const getToDoMatcherShowDetailID = createSelector(
  selectToDoMatcherState,
  fromToDoMatcher.getShowDetailID
)
export const getToDoMatcherShouldScrollToTop = createSelector(
  selectToDoMatcherState,
  fromToDoMatcher.getShouldScrollToTop
)
export const getToDoMatcherShowExhibitorDetailID = createSelector(
  selectToDoMatcherState,
  fromToDoMatcher.getExhibitorShowDetailID
)
...
export const getCompleteMatcherShowDetailID = createSelector(
  selectCompleteMatcherState,
  fromCompleteMatcher.getShowDetailID
)
export const getCompleteMatcherShouldScrollToTop = createSelector(
  selectCompleteMatcherState,
  fromCompleteMatcher.getShouldScrollToTop
)
export const getCompleteMatcherShowExhibitorDetailID = createSelector(
  selectCompleteMatcherState,
  fromCompleteMatcher.getExhibitorShowDetailID
)
